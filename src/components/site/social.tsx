...
/** Facebook "f" glyph — the profile to browse, not the Messenger bubble. */
...
/** Everywhere Torisabi can be followed, in one list the footer maps over. */
export const SOCIAL_LINKS: SocialLink[] = [
  { label: "Facebook", href: FACEBOOK_PROFILE_URL, Icon: FacebookIcon },
